...
function armorAdapt.spriteBuild(directory, config, parameters, level, seed)
	...
	elseif AAitemFolder ~= "null" then
		...
		if parameters.armorAdapt_tags.nullcheck == true then
			config.maleFrames = "/items/armors/armorAdapt/default/null/default/pantsm.png"
			config.femaleFrames = "/items/armors/armorAdapt/default/null/default/pantsf.png"
		else
			config.maleFrames = armorAdapt.defaultCheck(armorAdapt.constructPaths("/pantsm.png", config.maleFrames))
